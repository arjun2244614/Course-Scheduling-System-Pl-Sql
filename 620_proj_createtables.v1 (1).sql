...
insert into course values (127, 12, 'Deep Learning for Information Systems', 3, 'P/F', 2, 0, preReqList(122, 121), 'regular');
...
insert into prerequisite values (331, 121);
insert into prerequisite values (125, 121);
insert into prerequisite values (125, 331);
...
course_load_Id NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY,
instruc_id int,
Semester varchar(20),
Year number,
...
/*
insert into course_load values (course_load_Id_seq.nextval,1001, 'fall',2019,3,2);
insert into course_load values (course_load_Id_seq.nextval,1002, 'Spring',2019,2,4);
insert into course_load values (course_load_Id_seq.nextval,1003, 'Spring',2019,2,4);
insert into course_load values (course_load_Id_seq.nextval,2001, 'Summer',2019,4,3);
insert into course_load values (course_load_Id_seq.nextval,2002, 'Spring',2019,2,3);
insert into course_load values (course_load_Id_seq.nextval,2003, 'Spring',2019,1,3);
...
insert into registration values (5, 122, 5002, null, 2);
...
course_id number, num_Section_preferences number, Num_courses_assigned number) ON COMMIT DELETE ROWS;
